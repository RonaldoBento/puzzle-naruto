// Game Puzzle - Sliding: Desenvolvido em Portugol Studio
...
programa {
    ...
    /*Inclusões de bibliotecas
      Quando houver a necessidade de utilizar uma ou mais bibliotecas, 
      as inclusões devem aparecer antes de qualquer declaração */ 
    ...
    //Declarações de funções somente são permitidas dentro do programa.
	...
	funcao vazio desenhar_pronto() {
		g.desenhar_imagem(0, 0, img)
	}
	
	funcao vazio desenhar_jogando() {
	...
	funcao vazio inicio() {
		...
		/* Declarações de variáveis locais, constantes locais, 
